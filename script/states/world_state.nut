this.world_state <- this.inherit("scripts/states/state", {
	...
	function onDeserialize( _in )
	{
		...
		else if (this.Const.DLC.Wildmen && !this.World.Flags.get("IsWildmenCampaign"))
		{
			...
			this.Time.scheduleEvent(this.TimeUnit.Real, 6000, function ( _tag )
			{
				this.showDialogPopup("Old Campaign Loaded", "此战役是在激活“北方的勇士”DLC之前创建的。 请注意，即使你可以继续玩此战役，除非你开始新的战役，否则你将无法访问所有新内容。", null, null, true);
			}.bindenv(this), null);
		}
		else if (this.Const.DLC.Desert && !this.World.Flags.get("IsDesertCampaign"))
		{
			...
			this.Time.scheduleEvent(this.TimeUnit.Real, 6000, function ( _tag )
			{
				this.showDialogPopup("Old Campaign Loaded", "此战役是在激活“炽热沙漠”DLC之前创建的。 请注意，即使你可以继续玩此战役，除非你开始新的战役，否则你将无法访问所有新内容。", null, null, true);
			}.bindenv(this), null);
		}
