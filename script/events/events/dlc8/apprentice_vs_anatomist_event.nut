	...
	function create()
	{
		...
		this.m.Screens.push({
			...
			function start( _event )
			{
				...
				_event.m.Anatomist.improveMood(0.5, "教授了" + _event.m.Apprentice.getName() + " something");
