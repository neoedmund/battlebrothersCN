this.witch_burnings_situation <- this.inherit("scripts/entity/world/settlements/situations/situation", {
	...
	function create()
	{
		...
		this.m.Name = "焚烧女巫";
		this.m.Description = "一个火热的场面，焚烧女巫吸引观众，观众吸引了食品摊。然后，镇上肯定会有很多女巫猎人…";
		this.m.Icon = "ui/settlement_status/settlement_effect_32.png";
		this.m.Rumors = [
			"昨天来了一些女巫猎人。他们没有找到他们要找的东西，就去了 %settlement%。",
			"据我所知，他们在 %settlement% 发现了一个女巫，将要把她送进火堆。我想起来了，也许我该报告前几天在市场上打败我的那个老泼妇，她肯定是个女巫！"
		];
