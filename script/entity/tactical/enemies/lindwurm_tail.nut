	...
	function onDamageReceived( _attacker, _skill, _hitInfo )
	{
		...
		if (_hitInfo.DamageDirect < 1.0)
		{
			...
			if (this.m.Body.m.BaseProperties.Armor[_hitInfo.BodyPart] != 0)
			{
				...
				this.Tactical.EventLog.logEx(this.Const.UI.getColorizedEntityName(this) + "的natural armor被击中 [b]" + this.Math.floor(_hitInfo.DamageArmor) + "[/b] 伤害");
			}
