this.send_citystate_holysite_action <- this.inherit("scripts/factions/faction_action", {
	...
	function onExecute( _faction )
	{
		...
		{
			local party = _faction.spawnEntity(spawnpoints[i], "团" + _faction.getNameOnly(), true, this.Const.World.Spawn.Southern, this.Math.rand(90, 120) * this.getScaledDifficultyMult());
