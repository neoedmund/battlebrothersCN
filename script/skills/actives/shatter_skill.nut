	...
	function getTooltip()
	{
		...
		else
		{
			ret.push({
				...
				type = "text",
				icon = "ui/icons/hitchance.png",
				text = "Has [color=" + this.Const.UI.Color.NegativeValue + "]-10%[/color] 命中惩罚"
			});
		}
		...
		ret.extend([
			{
				...
				text = "有 [color=" + this.Const.UI.Color.PositiveValue + "]33%[/color] 几率在命中时造成趔趄"
			},
			{
				id = 9,
				type = "text",
				icon = "ui/icons/special.png",
				text = "Has a [color=" + this.Const.UI.Color.PositiveValue + "]33%[/color] 几率在命中时击退目标"
			},
			{
				id = 6,
				type = "text",
