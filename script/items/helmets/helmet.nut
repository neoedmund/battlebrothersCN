this.helmet <- this.inherit("scripts/items/item", {
	...
	function onDamageReceived( _damage, _fatalityType, _attacker )
	{
		...
		{
			this.Tactical.EventLog.logEx(this.Const.UI.getColorizedEntityName(this.getContainer().getActor()) + "的" + this.getName() + "被击中，受到 [b]" + this.Math.floor(_damage) + "[/b] 伤害 and has been destroyed!");
